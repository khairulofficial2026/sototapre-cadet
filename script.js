...
// হ্যাশ থেকে অতিরিক্ত স্পেস/কেস ভিন্নতা সহনীয় করার জন্য ছোট হেল্পার
function currentHash(){
  return (window.location.hash || "").trim().toLowerCase();
}
...
function checkRoutineEntry(){
  if(currentHash() === "#routine"){
    showRoutine();
  }
}
window.addEventListener("hashchange", checkRoutineEntry);

// পেইজ প্রথমবার লোড হওয়ার সময় হ্যাশ অনুযায়ী সঠিক পেইজ দেখানো (একবার এখনই,
// এবং window "load" ইভেন্টেও আরেকবার — যাতে ধীর নেটওয়ার্ক/ক্যাশ পরিস্থিতিতেও
// রুটিন/এডমিন পেইজ ঠিকমতো খোলে)
